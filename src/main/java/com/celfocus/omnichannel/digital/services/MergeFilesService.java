...
public interface MergeFilesService {
	...
	/**
	 * This method will merge the results obtained from the {@link getMergeStatus} method with the options the user selected on screen
	...
	/**
	 * THis method will save the merged result obtained from the {@link doMerge} method to the local file
